...
@Component({
  ...
  templateUrl: './hitting.page.html',
  styleUrls: ['./hitting.page.scss'],
})
export class HittingPage implements OnInit {
  currentSkill: Skill;
  ...
  ngOnInit() {
    this.currentSkill = this.volleyballSkillsService.getSkill('hitting');
  }
